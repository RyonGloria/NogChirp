...
sf = 10;
channelNum = 2;
collNum = 8; % 记录当前轮次冲突的数目
samplesRate = 2e6;
round = 40;
DEBUG = false;

filePath = "D:\CHchirp_20Nodes\Pyramid_SF";
savePath = ".\Result\CICSNRExp1\";
...
%                             signal = signal + noise;
            ...
            record{9, countAll} = trueRateRoundAll;
            record{10, countAll} = channelBinTrueRate;
            record{11, countAll} = preambleChannelNum;
            record{12, countAll} = SRRRecord;
